...
public class Constants {
    ...
    private static final String squareText = "   "; // Normale spatie + dunne spatie (U+2009) + haar spatie (U+200A)
    ...
    public static final String emptyPiece = ANSI_GREEN_BACKGROUND + squareText + ANSI_RESET;
