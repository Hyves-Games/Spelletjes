...
public enum SceneEnum {
    ...
    WAIT_ROOM_CHALLENGE(new ClientScene("waitingRoom", "waitingChallengeRoom","Waiting on opponent")),
    WAIT_ROOM_TOURNAMENT(new ClientScene("waitingRoom", "waitingTournamentRoom", "Tournament"));
